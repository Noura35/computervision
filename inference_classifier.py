...
cap = cv2.VideoCapture(0)  # Change the camera index to 0 for the default camera
...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            for i in range(len(hand_landmarks.landmark)):
                ...
                # Collect x and y coordinates of the landmarks
                x_.append(x)
                y_.append(y)
    ...
    # Wait for the key press to exit the loop
